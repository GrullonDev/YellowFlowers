...
Future<void> initDependencies() async {
  ...
  // Services
  sl.registerLazySingleton<JamendoApiService>(() => JamendoApiService(client: sl()));

  // Data sources
  sl.registerLazySingleton<MusicRemoteDataSource>(() => MusicRemoteDataSourceImpl(audioPlayer: sl(), apiService: sl()));

  // Legacy repository
  sl.registerLazySingleton<MusicRemoteRepository>(() => MusicRemoteRepositoryImpl(dataSource: sl()));

  // Domain repository wrapper
  sl.registerLazySingleton<MusicRepository>(() => MusicRepositoryImpl(remote: sl()));
